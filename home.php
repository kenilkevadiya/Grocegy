...
if(!isset($user_id)){
   // redirect karse login page par jo khotu hase
...
<div class="home-bg">
   ...
   <section class="home">
      ...
      <div class="content">
         <h3>Fresh And Organic <br> Your Daily Need Products</h3>
         <p>Farm Fresh Organic Vegetable, Fruits and Grocery. The freshest produce curetted everyday to
         give you variety and save your time.</p>
...
<section class="home-category">
   ...
   <div class="box-container">
      ...
      <div class="box">
         <img src="images/cat-1.png" alt="" height="180px">
         <a href="category.php?category=fruits" class="btn">fruits</a>
      </div>

      <div class="box">
         <img src="images/cat-3.png" alt="" height="180px">
         <a href="category.php?category=vegetables" class="btn">vegetables</a>
      </div>

      <div class="box">
         <img src="images/cat-2.png" alt="" height="180px">
         <a href="category.php?category=meat" class="btn" >meat</a>
      </div>

      <div class="box">
         <img src="images/cat-4.png" alt="" height="180px">
